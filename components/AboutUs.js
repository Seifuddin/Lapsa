        ...
        <div className="space-y-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-10">
            {[
              ...
              <div key={i} className="p-6 bg-blue-50 border border-orange-200 rounded-md shadow-md hover:shadow-lg flex flex-col items-center text-center">
                <service.icon className="w-8 h-8 text-orange-600 mb-4" />
                <h4 className="font-bold text-orange-600">{service.title}</h4>
