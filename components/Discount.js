    ...
    <section className="relative bg-green-50 dient-to-b from-gray-50 to-white py-24 px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h3 className="hidden text-sm font-semibold text-blue-800 tracking-widest uppercase">
            Limited-Time Offer
          </h3>
          ...
          >
            ...
            <a
              href="#contact"
              className="bg-blue-800 text-center md:px-8 md:py-4 text-white font-semibold py-2 px-3 rounded-lg shadow-md hover:bg-gray-100 transition"
            >
              Get a Free Quote
            </a>
            <a
