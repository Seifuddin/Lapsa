    ...
    <nav className="fixed w-full top-0 left-0 z-50 backdrop-blur-sm bg-blue-950/60 shadow-md">
                ...
                <div className="p-4 space-y-2">
                  <DropdownGroup
                    ...
                    links={[
                      ...
                      { href: "/services/seo", label: "SEO & Hosting" },
                    ]}
                  />
                  <hr />
                  <DropdownGroup
                    ...
                    links={[
                      ...
                      { href: "/services/flyers", label: "Flyers & Posters" },
                    ]}
                  />
                  <hr />
                  <DropdownGroup
                    ...
                    links={[
                      ...
                      { href: "/services/stickers", label: "Stickers" },
                      { href: "/services/banners", label: "Banners & Printing" },
                    ]}
                  />
                </div>
              </div>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <MobileLink href="/" isActive={isActive("/")}>Home</MobileLink>
            <MobileLink href="/about" isActive={isActive("/about")}>About</MobileLink>
            ...
            <div>
              ...
              <AnimatePresence>
                {mobileDropdownOpen && (
                  ...
                  >
                    <DropdownGroupMobile title="Web Development" color="text-blue-300" links={[
                      { href: "/services/web-design", label: "Web Design" },
                      { href: "/services/app-development", label: "App Development" },
                      { href: "/services/seo", label: "SEO & Hosting" },
                    ]} />
                    <DropdownGroupMobile title="Graphic Design" color="text-purple-300" links={[
                      { href: "/services/logos", label: "Logo Design" },
                      { href: "/services/business-cards", label: "Business Cards" },
                      { href: "/services/flyers", label: "Flyers & Posters" },
                    ]} />
                    <DropdownGroupMobile title="Art & Others" color="text-pink-300" links={[
                      { href: "/services/calendars", label: "Calendars" },
                      { href: "/services/stickers", label: "Stickers" },
                      { href: "/services/banners", label: "Banners & Printing" },
                    ]} />
            ...
            <MobileLink href="/contacts" isActive={isActive("/contacts")}>Contact</MobileLink>
          </motion.div>
        )}
      </AnimatePresence>
    </nav>
  ...
  return (
    <div>
      ...
      <ul className="space-y-1 text-sm">
        {links.map((link) => (
          <li key={link.href}>
            <Link href={link.href} className="hover:text-blue-500">{link.label}</Link>
          </li>
        ))}
      </ul>
    </div>
...
function DropdownGroupMobile({ title, color, links }) {
  return (
    <div>
      ...
      <ul className="ml-3 space-y-1">
        {links.map((link) => (
          <li key={link.href}>
            <Link href={link.href} className="block hover:underline">{link.label}</Link>
          </li>
        ))}
      </ul>
    </div>
