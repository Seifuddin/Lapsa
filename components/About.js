...
export default function AboutUs() {
  return (
    <section className="bg-gray-100 pb-0 pt-16 text-gray-800">
      {/* Intro */}
      ...
      {/* Image + Who We Are */}
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 px-6 py-16 items-center bg-gradient-to-tr from-orange-200 via-white to-orange-200">
        <img
