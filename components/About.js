    ...
    return (
        <section className="bg-gray-200 py-16">
            <div className="text-center">
                ...
                <h2 className="text-lg text-gray-950 font-semibold mb-10">We're more than just a printing company. We're your creative partner, dedicated to helping individuals and businesses alike bring their ideas to life with vibrant, high-quality prints.</h2>
                ...
                <a
                    href="#portfolio"
                        className="inline-block ml-0 rounded-md bg-orange-500 text-white py-2 px-8 text-sm font-semibold hover:bg-blue-600 transition-all duration-300"
                >
                    About Us
                </a>
                </div>
