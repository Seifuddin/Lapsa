...
export default function OurServices() {
  ...
  return (
    <section className="relative bg-gradient-to-tr from-orange-500 via-white to-orange-500 z-0 py-12 px-5 mx-auto">
      {/* Background image */}
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="rounded-2xl shadow-lg overflow-hidden bg-gray-200 transition duration-300 hover:shadow-2xl"
            >
              <img
                src={service.image}
                alt={service.title}
