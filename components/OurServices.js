        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="rounded-2xl border border-gray-400 shadow-lg overflow-hidden bg-gradient-to-tr from-blue-300 via-white to-orange-300 transition duration-300 hover:shadow-2xl"
            >
              <img
                src={service.image}
                alt={service.title}
