...
export default function Benefits() {
  return (
    <section className="relative bg-gray-50 bg-cover bg-center bg-no-repeat py-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        {/* Header */}
                ...
                >
                  ...
                  <p className="italic text-center text-blue-900 font-semibold text-lg max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 1 }}
            className="order-2 md:order-2 space-y-6 text-left"
          >
            ...
            <ul className="space-y-4 text-blue-950">
              {[
                ...
                <li key={index} className="flex items-start shadow-md bg-blue-50 gap-3 p-2 border">
